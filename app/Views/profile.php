...
if(isset($_SESSION['achiventdelete'])){
    $item = $_SESSION['achiventdelete'];
    if($item !== NULL){
        echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
        <strong>'.$item.'</strong>
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
...
<div class="card pt-5 pb-3" style="width:1000px;">
  <div class="row">
    ...
    <div class="col-md-4" >
      <div class="card-body">
        ...
        <h6>Totle achivments : <?=$all?></h6>
        <h6>Approved : <?=$approved?></h6>
        </div>
</div>
    </div>
  </div>
...
<div class="container my-5 ">
    ...
    <p>
        <a class="btn btn-primary  d-flex justify-content-evenly" style="width:800px; margin-left:250px;" href="<?=site_url('addachivment');?>" role="button" >
            Add achivment
        </a>
    </p>
...
<?php $i=0; foreach($achivments as $achivment): 
     ...
     if($achivment['aproovment']==0 && $achivment['category_id'] == session('user')->fcategory):?>
                ...
                <div class="row">
                    <div class="col">
                        <div class="card-body">
                            ...
                            <form class="mb-0" method="post" action="<?=site_url('deleteachivment')?>">
                    <input type="hidden" id="achivmentid" name="achivmentid" value="<?=$achivment['achivment_id']?>">
    ...
    <?php if(1):?>
     ...
     if(session('user')->profession == 1){
                ...
                <?php if($achivment['aproovment'] == 1 && $achivment['category_id'] ==  session('user')->fcategory):?>   
                    <div class="card w-75 my-2">
                        <div class="row">
                            <div class="col">
                                <div class="card-body">
